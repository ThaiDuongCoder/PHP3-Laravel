...
@section('content')
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div
            ...
            <h3 class="text-center mb-6 text-2xl font-bold text-gray-800">Đăng Ký</h3>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text"
                        class="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('name') border-red-500 @enderror"
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="togglePassword"
                            class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-700 z-10">
                ...
                <div class="mb-5">
                    <label for="password-confirm" class="block text-sm font-semibold text-gray-700 mb-2">Xác nhận mật
                        khẩu</label>
                    <input type="password"
                        class="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('password_confirmation') border-red-500 @enderror"
                        id="password-confirm" name="password_confirmation" placeholder="Xác nhận mật khẩu">
                ...
                <div class="mb-6">
                    ...
                    <input type="tel"
                        class="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm @error('phone') border-red-500 @enderror"
